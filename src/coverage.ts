...
export const CLIENT_COVERAGE: readonly ResourceCoverage[] = Object.freeze([
  ...
  Object.freeze({
    ...
    endpoints: [
      ...
      { path: "/packages/v2/inactive", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/onhold", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/types", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/adjust/reasons", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/{id}", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/{label}", method: "GET" as const, clientMethod: null, status: "planned" as const },
      { path: "/packages/v2/{id}/history", method: "GET" as const, clientMethod: null, status: "planned" as const },
    ] as const,
  } as const),
  Object.freeze({
    resource: "locations",
